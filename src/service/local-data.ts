import type { HeaderLinksType, FooterLinksType, FooterImagesType, DicoverMenuType, HotRadiosType, ArtistCategoriesType } from "@/type/local-data";
...
export const footerImages: FooterImagesType[] = [
  {
...
// discover中的数据
export const dicoverMenu: DicoverMenuType[] = [
  {
    title: "推荐",
...
// 歌手类别
export const artistCategories: ArtistCategoriesType[] = [
  {
    title: "推荐",
    area: -1,
    artists: [
